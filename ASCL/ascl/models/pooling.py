...
class GeneralizedMeanPoolingPart(GeneralizedMeanPooling, ABC):
    """ Same, but norm is trainable
    """

    def __init__(self, norm=3, output_size=(3,1), eps=1e-6):
        super(GeneralizedMeanPoolingPart, self).__init__(norm, output_size, eps)
        self.p = nn.Parameter(torch.ones(1) * norm)
...
__pooling_factory = {
    ...
    "gemp": GeneralizedMeanPoolingPart,
